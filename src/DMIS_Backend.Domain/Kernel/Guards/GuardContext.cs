...
/// 記錄 Guard 驗證失敗時的位置資訊，用於錯誤追蹤和日誌記錄
/// </summary>
/// <param name="Member">觸發 Guard 的成員名稱（方法或屬性）</param>
/// <param name="File">觸發 Guard 的檔案路徑</param>
/// <param name="Line">觸發 Guard 的行號</param>
/// <param name="ArgumentExpression">觸發 Guard 的參數表達式（可選）</param>
